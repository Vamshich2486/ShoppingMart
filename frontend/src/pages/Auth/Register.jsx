...
import backgroundImage from "../../components/register-unsplash.jpg"
const Register = () => {
  ...
  return (
    <section className="pl-[10rem] flex flex-wrap h-screen w-full bg-cover bg-center" style={{backgroundImage : `url(${backgroundImage})`}}>
